...
#include <stdarg.h> // del
#include <stdbool.h> // del
#include <stdio.h>	//del
...
//  sprintf(str, "ID: 0x%02X", value) ; // del
//  SSD1306_GotoXY(0, 0) ; // del
//  SSD1306_Puts(str, &Font_11x18, 1) ; //del
//  SSD1306_UpdateScreen() ; //del
//  if(value !=BME280_ID)
//  	  {
//  	    Error();
//  	    return;
...
//  sprintf(str, "Stat: %04X", value32);
//  SSD1306_GotoXY(0, 20) ; // del
//  SSD1306_Puts(str, &Font_11x18, 1) ; //del
////  HAL_UART_Transmit(&huart2,(uint8_t*)str1,strlen(str1),0x1000);
//  sprintf(str, "T: %s P: %s H: %s",
